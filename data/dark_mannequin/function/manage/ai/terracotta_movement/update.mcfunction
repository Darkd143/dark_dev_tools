...
$execute unless function dark_player:manage/rotation/get/horizontal/direction/$(movement_direction) run function dark_player:manage/rotation/set/direction/horizontal/$(movement_direction)
