...
execute as @n[tag=dark_mannequin.new_ai] run function dark_mannequin:manage/id/link_entity with storage dark_mannequin.temp

# Apply Team Collision Rule
function dark_mannequin:manage/ai/apply/helper/team
