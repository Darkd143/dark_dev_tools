...
# Movement
$execute unless function dark_mannequin:manage/ai/helper/has_hurt_time run tp @s @n[tag=dark_mannequin.ai_selector,scores={dark_mannequin.id=$(id)}]
$execute if function dark_mannequin:manage/ai/helper/has_hurt_time run tp @n[tag=dark_mannequin.ai_selector,scores={dark_mannequin.id=$(id)}] @s
