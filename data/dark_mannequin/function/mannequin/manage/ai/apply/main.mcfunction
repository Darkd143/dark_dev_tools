...
$execute if score @s dark_mannequin.ai.type matches 1 run function dark_mannequin:mannequin/manage/ai/apply/entity/main {entity_id:$(entity_id)}
execute if score @s dark_mannequin.ai.type matches 2 run function dark_mannequin:mannequin/manage/ai/apply/pathing/main