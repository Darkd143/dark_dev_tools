...
execute as @n[type=minecraft:mannequin,tag=dark_mannequin.mannequin] at @s unless entity @n[type=minecraft:armor_stand,tag=dark_mannequin.temp_equipment,distance=..1] if data entity @s equipment.legs run function dark_mannequin:mannequin/manage/inventory_swap/armor_stand/summon with storage dark_mannequin.temp
